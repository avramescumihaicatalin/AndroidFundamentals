 ...
 *   - spread inside -> distante egale doar intre elemente, nu si in capete.
 *   - packed -> toate view-urile sunt grupate
 *   - weighted -> pentru chan: spread sau sprea_inside se poate seta un layout_constraintHorizontal_weight
 * la fel ca la weight din LinearLayout.
 *
 ...
 * Ca sa te asiguri ca nu se intampla asta a fost adaugata proprietatea text dar care e din
 ...
 *   apropiat view. Icon-ul pentru a face asta e cel cu magnet.
 ...
 *  latimea dinamic sau sa folosesti layout de procentaj dar poti face in ConstraintLayout
 ...
 *  cealalta va fi calculata in asa fel incat sa pastreze ratio.
 *     Am doua imagini. Pe prima o setez cu constrangeri top left right si pe cealalta left si right.
